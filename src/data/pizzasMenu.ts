...
const RAW_MENU: Array<{ name: string; pomodoro: number; notes: string }> = [
  ...
  { name: 'Wurstel', pomodoro: 90, notes: 'Wurstel' },
  { name: 'Hot-Dog', pomodoro: 90, notes: "Wurstel, ketchup piccante, tuorlo d'uovo" },
  { name: 'Valdostana', pomodoro: 0, notes: 'Speck' },
  { name: 'Capricciosa', pomodoro: 90, notes: 'Funghi, prosciutto cotto, olive nere, carciofini' },
  { name: 'Boscaiola', pomodoro: 0, notes: 'Funghi champignon, salsiccia, prezzemolo, aglio' },
  { name: 'Carrettiera con Salsiccia e Friarielli', pomodoro: 0, notes: 'Salsiccia, friarielli, provola affumicata, peperoncino, aglio' },
